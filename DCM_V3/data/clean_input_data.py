...
'''
possession_df = pd.read_csv("data/possession/raw/possession_week03_raw.csv")
possession_df = clean_player_names(possession_df)
possession_df.to_csv("data/possession/raw/possession_week03.csv",index=False)
print("Cleaned possession data saved to data/possession/raw/possession_week03.csv")
'''

dcm_df = pd.read_csv("data/dcm/raw/dcm_week03_raw.csv")
dcm_df = clean_dcm_raw(dcm_df)
dcm_df.to_csv("data/dcm/raw/dcm_week03.csv",index=False)
print("Cleaned DCM data saved to data/dcm/raw/dcm_week03.csv\n\n")